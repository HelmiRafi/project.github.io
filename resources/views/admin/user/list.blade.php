        ...
        <div class="modal fade" id="modalCreate" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form method="POST" action="/user/store" enctype="multipart/forms-data">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="modalEdit {{$d->id}}" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form method="POST" action="/user/update/{{$d->id}}" enctype="multipart/forms-data">
                                                    @csrf
                                                <div class="modal-body">
													<div class="form-group">
                                                        <label>Nama User</label>
...
<div class="modal fade" id="modalHapus {{$b->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="/user/destroy/{{$b->id}}" enctype="multipart/forms-data">
                @csrf
            <div class="modal-body">
				<div class="form-group">
