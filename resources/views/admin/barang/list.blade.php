        ...
        <div class="modal fade" id="modalCreate" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form method="POST" action="/barang/store" enctype="multipart/forms-data">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="modalEdit {{$d->id}}" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form method="POST" action="/barang/update/{{$d->id}}" enctype="multipart/forms-data">
                                                    @csrf
                                                <div class="modal-body">
													...
													<div class="form-group">
														<div class="input-group mb-3">
															...
															<input type="number" class="form-control" value="{{$d->harga}}" placeholder="Harga..." name="harga">
														</div>
													</div>					
												</div>
												<div class="modal-footer no-bd">
...
<div class="modal fade" id="modalHapus {{$b->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="/barang/destroy/{{$b->id}}" enctype="multipart/forms-data">
                @csrf
            <div class="modal-body">
				<div class="form-group">
